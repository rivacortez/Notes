package com.ensolvers.platform.iam.interfaces.rest;

import com.ensolvers.platform.iam.domain.services.UserCommandService;
import com.ensolvers.platform.iam.interfaces.rest.resources.AuthenticatedUserResource;
import com.ensolvers.platform.iam.interfaces.rest.resources.SignInResource;
import com.ensolvers.platform.iam.interfaces.rest.resources.SignUpResource;
import com.ensolvers.platform.iam.interfaces.rest.resources.UserResource;
import com.ensolvers.platform.iam.interfaces.rest.transform.AuthenticatedUserResourceFromEntityAssembler;
import com.ensolvers.platform.iam.interfaces.rest.transform.SignInCommandFromResourceAssembler;
import com.ensolvers.platform.iam.interfaces.rest.transform.SignUpCommandFromResourceAssembler;
import com.ensolvers.platform.iam.interfaces.rest.transform.UserResourceFromEntityAssembler;
